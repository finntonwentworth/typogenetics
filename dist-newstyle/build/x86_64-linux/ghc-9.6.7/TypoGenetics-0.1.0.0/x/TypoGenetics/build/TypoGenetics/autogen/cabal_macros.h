...
/* package TypoGenetics-0.1.0.0 */
#ifndef VERSION_TypoGenetics
#define VERSION_TypoGenetics "0.1.0.0"
#endif /* VERSION_TypoGenetics */
#ifndef MIN_VERSION_TypoGenetics
#define MIN_VERSION_TypoGenetics(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_TypoGenetics */
...
#define CURRENT_COMPONENT_ID "TypoGenetics-0.1.0.0-inplace-TypoGenetics"
